...
**Note (v121r addition, 2026-06-11)**: на peak configs **wnd=0** новый champion `fa_v121r_diet` (Sr→half2 softmax pipeline, +2-6% над v121 на bh≥32 ∨ sl≥4096). На configs **wnd>0** проигрывает v121 −7..−11% (mask cost в half2-pipeline). Граница чистая по wnd.
...
| 16 | 4096 | 0 | **fa_v121r_diet** | **466.4** | +2.5% v96b/v121 |
| 32 | 2048 | 0 | **fa_v121r_diet** | **427.9** | +3.1% v96b |
| 32 | 4096 | 0 | **fa_v121r_diet** | **556.8** | +1.4% v121 |
| 32 | 8192 | 0 | **fa_v121r_diet** | **611.7** | +4.2% v121 |
| 64 | 4096 | 0 | **fa_v121r_diet** | **580.2** | +5.0% v96b |
| 64 | 8192 | 0 | **fa_v121r_diet** | **620.7** | +2.5% v121 |
| 128 | 2048 | 0 | **fa_v121r_diet** | **528.3** | +4.0% v96b |
| 128 | 4096 | 0 | **fa_v121r_diet** | **598.2** | +2.9% v121 |
| 128 | 8192 | 0 | **fa_v121r_diet** | **624.8** | +3.3% v121 |
| 256 | 2048 | 0 | **fa_v121r_diet** | **553.9** | +3.4% v121 |
| 256 | 4096 | 0 | **fa_v121r_diet** | **601.8** | +3.4% v121 |
