#!/bin/bash
# 055 §1.b ABBA: base (040 252r) vs cand (055 §1.b 254r LDG-reg-prefetch)
BASE=/data/lib/podman-data/projects/goml/runs/archive/055_pre/r2c_merged_wall
CAND=/data/lib/podman-data/projects/goml/runs/archive/055_pre/r2c_merged_wall_cand_1b
LOG=/data/lib/podman-data/projects/goml/runs/reports/055_abba_1b_data.txt
> "$LOG"
echo "=== 055 §1.b ABBA: base(040 252r) vs cand(LDG-reg 254r) ===" | tee -a "$LOG"
