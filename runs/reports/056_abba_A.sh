#!/bin/bash
BASE=/data/lib/podman-data/projects/goml/runs/archive/056_pre/r2c_merged_wall_base
CAND=/data/lib/podman-data/projects/goml/runs/archive/056_pre/r2c_merged_wall_cand_A
LOG=/data/lib/podman-data/projects/goml/runs/reports/056_abba_A_data.txt
> "$LOG"
echo "=== 056 A-fix ABBA: base(040 252r) vs cand(L2-hint distributed 252r) ===" | tee -a "$LOG"
