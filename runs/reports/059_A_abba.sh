...
LOG=/data/lib/podman-data/projects/goml/runs/reports/059_A_abba_data.txt
> "$LOG"
echo "=== 059 A-fix RETEST clean stand: base(040 252r) vs cand(056 A-fix 252r) ===" | tee -a "$LOG"
