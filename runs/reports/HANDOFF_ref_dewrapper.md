...
git log -1
# ожидается subject: "HANDOFF: ТЗ A-LLM-5 квант-контракт O(1) (финал, ревью принято)"
# это doc-only коммит; цепочка вниз: b98bc89 (doc) -> c319212 (КОДОВЫЙ, A-LLM-4
# локализации) -> a51b042 -> f340ab9 -> 2d576c1 (A-LLM-3 F64-эталон) -> ...
