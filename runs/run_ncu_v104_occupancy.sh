#!/bin/bash
# NCu profile v104 vs v102 + v96 on PEAK config (cfg=9 = bh=64 sl=8192).
...
profile "v102" "$GOML/runs/fa_v102_nosmvt"    9
profile "v104" "$GOML/runs/fa_v104_br96"      9

echo "================================================================"
echo "EXPECTED: v104 should show 12 warps/SM (2 blocks × 6 warps) same as v102"
echo "        but with LOWER math_pipe/mio/short_scb (less SMEM contention)"
echo "Reality check: actual warps active + stall pattern"
echo "================================================================"
