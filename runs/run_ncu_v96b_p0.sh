#!/bin/bash
# P0: NCu профиль v96b localfix на cfg=9 (peak) — baseline для сравнения с v111-mbarrier.

set -uo pipefail

NCU=/usr/local/cuda-13.1/bin/ncu
GOML=/data/lib/podman-data/projects/goml
BIN="$GOML/runs/fa_v96b_localfix"
...
OUTS=$GOML/runs/ncu_v96b_stallpct_cfg9.csv
OUTU=$GOML/runs/ncu_v96b_util_cfg9.csv

echo "=== v96b localfix cfg=9 ==="
...
python3 - "$OUTS" "$OUTU" "v96b localfix cfg=9" << 'PYEOF'
import csv, io, sys
